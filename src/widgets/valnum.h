...
class TENACITY_DLL_API NumValidatorBase /* not final */ : public wxValidator
{
public:
...
class TENACITY_DLL_API IntegerValidatorBase /* not final */
...
class TENACITY_DLL_API FloatingPointValidatorBase /* not final */
   : public NumValidatorBase
{
public:
...
TENACITY_DLL_API double RoundValue(int precision, double value);
